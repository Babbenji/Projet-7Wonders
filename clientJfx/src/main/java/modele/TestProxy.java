...
public class TestProxy
{
    public static void main(String[] args) throws Exception {
        ...
        ProxySevenWondersOnLineImpl facade = new ProxySevenWondersOnLineImpl();
        List<ICarte> lc = facade.serviceSevenWondersOnline.recuperationDonnees();
        List<IMerveille> lm = facade.serviceSevenWondersOnline.recuperationDonnees2();
