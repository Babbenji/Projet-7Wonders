...
public class GestionsEffetCarte implements Serializable {
    ...
    public void appliquerEffetCarte (Map<String,String> effet, IJoueur joueur, IJoueur voisinGauche , IJoueur voisinDroite)
    {
    ...
    public void appliquerEffetGuildesFinDePartie(Map<String,String> effet, IJoueur joueur,IJoueur voisinGauche , IJoueur voisinDroite) {
